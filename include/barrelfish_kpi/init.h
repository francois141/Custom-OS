...
#define ROOTCN_SLOT_CAPV         14  ///< Slot for capabilities given to the spawned process
...
#define TASKCN_SLOT_STDIN_FRAME 22  ///< UMP Frame overriding stdin
#define TASKCN_SLOT_STDOUT_FRAME 23  ///< UMP Frame overriding stdout
#define TASKCN_SLOTS_USER       24  ///< First free slot in taskcn for user
