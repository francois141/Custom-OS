...
#define ARMv8_L0_ENTRIES(limit) (VMSAv8_64_L0_INDEX((limit) - 1) + 1)
#define ARMv8_L1_ENTRIES(limit) (VMSAv8_64_L1_INDEX((limit) - 1) + 1)
#define ARMv8_L2_ENTRIES(limit) (VMSAv8_64_L2_INDEX((limit) - 1) + 1)
#define ARMv8_L3_ENTRIES(limit) (VMSAv8_64_L3_INDEX((limit) - 1) + 1)
