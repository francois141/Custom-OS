...
/// verbose debugging defines
#define DEBUG_SPAWN     0  ///< enables spawn, setup cspace, etc. output
#define DEBUG_MORECORE  0  ///< enables "initializing dynamic heap" output
#define DEBUG_AOS_RPC   0  ///< enables "remote endpoint capability received and initialized"
#define DEBUG_PROC_MGMT 0  ///< enables "Process exited with code [...]"
