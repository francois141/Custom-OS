...
struct sysret sys_dispatcher_stop(struct capability *to);
struct sysret sys_dispatcher_resume(struct capability *to);
struct sysret
...
struct sysret sys_monitor_nullify_domcap(struct capability *root, capaddr_t cptr, uint8_t bits);
