    ...
    )
{
    ...
    return sys_dispatcher_resume(to);
}
...
INVOCATION_HANDLER(monitor_nullify_domcap)
{
    (void)kernel_cap;
    INVOCATION_PRELUDE(5);
    errval_t err;
    ...
    return sys_monitor_nullify_domcap(root, cptr, bits);
}
...
static invocation_t invocations[ObjType_Num][CAP_MAX_CMD] = {
    ...
    [ObjType_Kernel] = {
        ...
        [KernelCmd_Nullify_domcap]    = monitor_nullify_domcap,
