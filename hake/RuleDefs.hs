...
armv8Image target menu bootTarget cpuTarget modules_generic modules =
    ...
    in Rules [
        ...
        Rule ([ Str Config.aarch64_objcopy,
            ...
            Out "root" blob_o ]),
        Rule ([ Str Config.aarch64_ld,
            In SrcTree "tools" "/tools/armv8_bootimage/crt0-efi-aarch64.o",
            Str "-znocombreloc",
            Str "-Bsymbolic",
            Str "-T", In SrcTree "tools" "/tools/armv8_bootimage/elf_aarch64_efi.lds",
            Str "-shared",
            Str "--no-undefined",
            ...
            Str "-o",
            Out "root" image_o,
            In SrcTree "tools" "/tools/armv8_bootimage/libgnuefi.a",
            In SrcTree "tools" "/tools/armv8_bootimage/libefi.a" ]),
        Rule ([ Str Config.aarch64_objcopy,
            Str "-O binary",
