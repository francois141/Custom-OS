...
errval_t enet_probe(struct enet_driver_state* st);
errval_t enet_init(struct enet_driver_state* st);
errval_t enet_device_init(struct enet_driver_state* st);

void enet_read_mac(struct enet_driver_state* st);
